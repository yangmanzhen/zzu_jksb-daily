...
def sign_in(id, pwd, name="Turing", check_today=1):
   ...
   # 获取fun218参数
    ...
    form = {
        ...
        "myvs_13b": "3606",  # 地市：地级市编码 对应身份证前四位  郑州市=4101
        "myvs_13c": "江西省.鹰潭市",  # 自己填写当前所在地即可
        "myvs_24": "否",
        ...
        "fun3": "",
        # "jingdu": "117.03732",  # 经度： 北校区经度,jingdu=113.658055
        # "weidu": "28.23913",  # 纬度： 北校区纬度,&weidu=34.782807  东经113.658333北纬34.7822222
        "ptopid": ptopid,
        "sid": sid,
    }
    headers = {
